...
<details>
  ...
  - Use o comando: `git clone git@github.com:tryber/sd-022-b-project-starwars-planets-search.git`.
  ...
  - Agora crie uma branch à qual você vai submeter os `commits` do seu projeto
    ...
    - Exemplo: `git checkout -b joaozinho-sd-022-b-project-starwars-planets-search`
  ...
  - Usando o exemplo anterior: `git push -u origin joaozinho-sd-022-b-project-starwars-planets-search`

  6. Crie um novo `Pull Request` _(PR)_

  - Vá até a página de _Pull Requests_ do [repositório no GitHub](https://github.com/tryber/sd-022-b-project-starwars-planets-search/pulls)
  ...
  - Volte até a [página de _Pull Requests_ do repositório](https://github.com/tryber/sd-022-b-project-starwars-planets-search/pulls) e confira que o seu _Pull Request_ está criado
